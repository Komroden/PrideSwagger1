        ...
        <div className="main_content_central">
            ...
            <div className="main_for_all_pages">
                <div className="main_content_right_sidebar_title_bl gost_top">
                    ...
                    <div className="gost_text_center">
                        ...
                        <span className="norm_text">вами интересовались за неделю <span
                            className="red_col">{value.data.length+' '+text}</span></span>
                    </div>
                    {value.data.length>25&&<div className="gost_red_block">
                    ...
                    {value.data.length>10&&<div className="gost_red_block" style={{backgroundColor: '#e6fa8e',color:'#0f20d9'}}>
                        <div className="gost_red_block_title">Вами Интересуются!</div>
                        <div className="gost_red_block_descr">Продолжайте в том же духе.</div>
                    </div>}
                    {value.data.length<10&&<div className="gost_red_block" style={{backgroundColor: '#8efa9f',color:'#122928'}}>
                ...
                <div className="gost_row">
                    ...
                    {value.data.map(item=><LkGuestMainGuestItem key={item.id} id={item.id}  name={item.firstName} setOpenModal={setOpenModal} image={item.image} isOnline={item.isOnline} year={item.yearsOld}/>)}
                </div>
                {value.data.length>15&&<a href="/" className="more_news open_more_gost">
