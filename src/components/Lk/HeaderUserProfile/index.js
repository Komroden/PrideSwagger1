    ...
    return (
        <div className={"user_part "+homeClassName}>
            <div className={"user_part_text "+textClassName}>
                ...
                <a onClick={auth.token!=null?handleLogout:handlePushLogin} className={buttonClassName?`user_part_exit ${buttonClassName}`:"user_part_exit"}>{auth.token!=null?'Выход':'Вход'}</a>
            </div>
