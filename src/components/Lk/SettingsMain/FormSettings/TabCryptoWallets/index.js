...
export const TabCryptoWalets = () => {
    ...
    const post=useFetchHandlePostWithBody('http://lk.pride.kb-techno.ru/api/Profile/requisites/add-crypto-wallet',payload,handleReset,setOpenSnack,'POST','Неправильный код')
